...
public class LandscapeGeneratorFollowing : MonoBehaviour
{
    ...
    private void ApplyNoise()
    {
        ...
        for(int i = 0; i< vertices.Length; i++)
        {
            ...
            float y = Mathf.PerlinNoise((x+transform.position.x)*noiseZoom, (z+transform.position.z)*noiseZoom)*noiseScale;
